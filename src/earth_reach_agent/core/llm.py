...
class BaseLLM:
    ...
    def __init__(
        ...
        Args:
            ...
            api_key (Optional[str]): The API key for authentication with the LLM provider.
    ...
    def generate(
        self, user_prompt: str, system_prompt: Optional[str] = None, image=None
    ) -> str:
        """
...
class GroqLLM(BaseLLM):
    ...
    def __init__(self, model_name: str, api_key: Optional[str] = None) -> None:
        ...
        Args:
            ...
            api_key (Optional[str]): The API key for authentication with the Groq API.
...
class OpenAILLM(BaseLLM):
    ...
    def __init__(self, model_name: str, api_key: Optional[str] = None) -> None:
        ...
        Args:
            ...
            api_key (Optional[str]): The API key for authentication with the OpenAI API.
